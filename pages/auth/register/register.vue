<template>
	<view class="wrap">
		...
		<view class="content">
			...
			<u-form-item label="昵称" label-width='160rpx'><u-input v-model="name" type="text" :border="false" /></u-form-item>
			<u-form-item label="邮箱" label-width='160rpx'><u-input v-model="email" type="text" :border="false" /></u-form-item>
			<u-form-item label="密码" label-width='160rpx'><u-input v-model="password" type="password" :border="false" /></u-form-item>
			<u-form-item label="确认密码" label-width='160rpx'><u-input v-model="password_confirmation" type="password" :border="false" /></u-form-item>
