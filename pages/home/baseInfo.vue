	...
	<view>
		...
		<view class="u-m-t-20" title-width='30'>
			<u-cell-group>
				...
				<u-cell-item title="昵称" title-width='200' @tap='count = 1 '>
					<u-input @blur='basename' v-model="name" focus type="text" placeholder='请输入你的昵称' :border="false"
						v-if="count===1" /><text v-else>{{name}}</text>
				</u-cell-item>
